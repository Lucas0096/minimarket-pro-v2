...
const DashboardSidebar = ({ activeSection, onSectionChange }) => {
  const navItems = [
    ...
    { id: 'sales', name: 'Ventas', icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h10M3 10l2-6h14l2 6M3 10v8a2 2 0 002 2h14a2 2 0 002-2v-8" />
      </svg>
    )},
    ...
    { id: 'subscriptions', name: 'Suscripciones', icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2zm3-7h.01M12 15h.01M15 15h.01" />
      </svg>
    )},
  ...
  return (
    <aside className="w-64 bg-gray-900 border-r border-gray-700 flex flex-col">
      <div className="p-4 text-center text-white text-xl font-semibold border-b border-gray-700">
        Minimarket PRO
      </div>
